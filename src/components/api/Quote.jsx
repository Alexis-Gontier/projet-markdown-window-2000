...
const CitationDuJour = () => {
  ...
  return (
    <div className="absolute bottom-[90px] left-50 w-96 flex items-center bg-[#D7D0C8] after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-px after:bg-[#000]">
