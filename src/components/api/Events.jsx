...
const EventsDuJour = () => {
  ...
  return (
    <div className="absolute bottom-[110px] left-4 w-96 bg-[#D7D0C8] flex items-center after:content-[''] after:absolute after:bottom-0 after:left-0 after:w-full after:h-px after:bg-[#000]">
      <div className="p-px">
